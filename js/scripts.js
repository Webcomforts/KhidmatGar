...
// sticky headers$(window).scroll(function() {	if($("body").width() > 800) {		var header = $(".root>header.sticky-enabled");		var headerHeight = header.height();		var scrollTop = $(window).scrollTop();		if (scrollTop > headerHeight) {			if (!header.hasClass('sticky')) {				header.addClass('sticky');				header.animate({top: 0}, 600);				$('.root').css("padding-top", headerHeight);			}		} else {			if (header.hasClass('sticky')) {				header.removeClass('sticky');				header.removeAttr('style');				$('.root').removeAttr('style');			}		}	}});
